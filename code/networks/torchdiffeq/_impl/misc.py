...
def _select_initial_step(fun, t0, y0, conditioning, order, rtol, atol, f0=None):
...
def _check_inputs(func, y0, t, conditioning):
    tensor_input = False
    if torch.is_tensor(y0):
        tensor_input = True
        y0 = (y0,)
        _base_nontuple_func_ = func
        func = lambda t, y, conditioning: (_base_nontuple_func_(t, y[0], conditioning[0]),)
    ...
    if _decreasing(t):
        ...
        func = lambda t, y, conditioning: tuple(-f_ for f_ in _base_reverse_func(-t, y, conditioning))
