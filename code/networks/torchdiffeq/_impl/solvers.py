...
class AdaptiveStepsizeODESolver(object):
    ...
    def __init__(self, func, y0, conditioning, atol, rtol, **unused_kwargs):
...
class FixedGridODESolver(object):
    ...
    def __init__(self, func, y0, conditioning, step_size=None, grid_constructor=None, **unused_kwargs):
        ...
        if step_size is not None and grid_constructor is None:
            ...
            self.grid_constructor = lambda f, y0, conditioning, t: t
        else:
    ...
    def _grid_constructor_from_step_size(self, step_size):
        ...
        def _grid_constructor(func, y0, conditioning, t):
            start_time = t[0]
            end_time = t[-1]
    ...
    @abc.abstractmethod
    def step_func(self, func, t, dt, y, conditioning):
        pass
    ...
    def integrate(self, t):
        ...
        time_grid = self.grid_constructor(self.func, self.y0, conditioning, t)
        ...
        for t0, t1 in zip(time_grid[:-1], time_grid[1:]):
            dy = self.step_func(self.func, t0, t1 - t0, y0, conditioning)
