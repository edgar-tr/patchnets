...
def evaluate(results_folder, checkpoint, data_dir, split_filename):
        ...
        for class_name in split[dataset]:
            for instance_name in split[dataset][class_name]:
                ...
                reconstructed_mesh_filename = ws.get_reconstructed_mesh_filename(
                    results_folder, checkpoint, dataset, class_name, instance_name
                )
    ...
    with open(
        os.path.join(
            ws.get_evaluation_dir(results_folder, checkpoint, True), "chamfer.csv"
        ),
        "w",
    ) as f:
